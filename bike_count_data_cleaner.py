...
BINTOTALS = [
		...
		'all_on_western_road',
			# Male Traffic volume on road segment
...
bintotalout.write('count_id | site_id | bin_start | bin_duration | all_movements_at_intersection | total_male_using_intersection | total_female_using_intersection | all_on_northern_road | all_on_eastern_road | all_on_southern_road | all_on_western_road | male_on_northern_road | male_on_eastern_road | male_on_southern_road | male_on_western_road | female_on_northern_road | female_on_eastern_road | female_on_southern_road | female_on_western_road | all_from_north | all_from_east | all_from_south | all_from_west | male_from_north | male_from_east | male_from_south | male_from_west | female_from_north | female_from_east | female_from_south | female_from_west | all_to_north | all_to_east | all_to_south | all_to_west | male_to_north | male_to_east | male_to_south | male_to_west | female_to_north | female_to_east | female_to_south | female_to_west | all_from_north_to_west | all_from_north_to_south | all_from_north_to_east | all_from_east_to_north | all_from_east_to_west | all_from_east_to_south | all_from_south_to_east | all_from_south_to_north | all_from_south_to_west | all_from_west_to_south | all_from_west_to_east | all_from_west_to_north')
bintotalout.write('\n')
...
# Open json file that describe where to find the values we are interested in:
excelfiles 	= json.load(open('spreadsheetdetails.json'))
#summary_calculations = json.load(open('summary_calculations.json'))
